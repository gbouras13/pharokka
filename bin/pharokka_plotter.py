...
def get_input():
    ...
    parser.add_argument('--annotations', action="store",  default='1', help='Controls the proporition of annotations labelled. Must be a number between 0 and 1 inclusive. \n0 = no annotations, 0.5 = half of the annotations, 1 = all annotations. Defaults to 1. Chosen in order of CDS size.')
...
if __name__ == "__main__":
    ...
    plot.create_plot( gff_file, gbk_file, args.interval, args.annotations, args.title_size, args.plot_title, args.truncate, plot_file, args.dpi, args.label_size, args.label_hypotheticals, args.remove_other_features_labels)
