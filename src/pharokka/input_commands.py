...
def validate_gene_predictor(gene_predictor, genbank_flag):
    if gene_predictor == "phanotate":
        ...
        logger.info("pyrodigal-rv will be used for gene prediction.")
        ...
        logger.error(
            "Error: gene predictor was incorrectly specified. Please use 'phanotate', 'prodigal', 'prodigal-gv' or 'pyrodigal-rv'."
        )
